...
const ViewMyCart = () => {
  ...
  const retrieveCart = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/cart/fetch?userId=" + user.id,
      {
        headers: {
  ...
  const deleteCart = (cartId, e) => {
    ...
    fetch("https://online-registration-production.up.railway.app/api/cart/delete", {
      method: "DELETE",
      headers: {
  ...
  const incrementCart = (cart, e) => {
    ...
    fetch("https://online-registration-production.up.railway.app/api/cart/update", {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
                  ...
                  return (
                    <tr>
                      <td>
                        <img
                          src={
                            "https://online-registration-production.up.railway.app/api/food/" + cart.food.image1
                          }
                          class="img-fluid"
                          alt="food_pic"
                          style={{
