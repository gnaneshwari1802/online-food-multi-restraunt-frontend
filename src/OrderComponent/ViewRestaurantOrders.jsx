...
const ViewRestaurantOrders = () => {
  ...
  const retrieveAllorders = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/order/fetch/restaurant-wise?restaurantId=" +
        restaurant.id,
      {
        headers: {
  ...
  const retrieveAllUser = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/user/fetch/restaurant/delivery-person?restaurantId=" +
        restaurant.id,
      {
        headers: {
          Authorization: "Bearer " + restaurant_jwtToken, // Replace with your actual JWT token
  ...
  const assignToDelivery = (orderId, e) => {
    ...
    fetch("https://online-registration-production.up.railway.app/api/order/assign/delivery-person", {
      method: "PUT",
      headers: {
