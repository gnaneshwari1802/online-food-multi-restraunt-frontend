...
const ViewDeliveryOrders = () => {
  ...
  const retrieveAllorders = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/order/fetch/delivery-wise?deliveryPersonId=" +
        deliveryPerson.id,
      {
        headers: {
  ...
  const retrieveAllDeliveryStatus = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/order/fetch/delivery-status/all"
    );
    console.log(response.data);
    return response.data;
  };
  ...
  const retrieveAllDeliveryTiming = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/order/fetch/delivery-time/all"
    );
    console.log(response.data);
    return response.data;
  };
  ...
  const retrieveOrdersById = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/order/fetch?orderId=" + orderId
    );
    console.log(response.data);
    return response.data;
  };
  ...
  const updateOrderStatus = (orderId, e) => {
    ...
    fetch("https://online-registration-production.up.railway.app/api/order/update/delivery-status", {
      method: "PUT",
      headers: {
                  ...
                  return (
                    <tr>
                      ...
                      <td>
                        <img
                          src={
                            "https://online-registration-production.up.railway.app/api/food/" +
                            order.food.image1
                          }
                          class="img-fluid"
                          alt="food_pic"
