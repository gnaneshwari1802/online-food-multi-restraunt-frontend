      ...
      try {
        ...
        if (categoryId == null) {
          ...
          response = await axios.get(
            `https://online-registration-production.up.railway.app/api/food/fetch/restaurant-wise?restaurantId=${restaurant.id}`
          );
        } else {
          // Fetch foods by category
          response = await axios.get(
            `https://online-registration-production.up.railway.app/api/food/fetch/restaurant-wise/category-wise?restaurantId=${restaurant.id}&categoryId=${categoryId}`
          );
        }
        if (response.data) {
