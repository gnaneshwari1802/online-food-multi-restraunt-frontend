...
const ViewRestaurantFoods = () => {
  ...
  const retrieveAllFoods = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/food/fetch/restaurant-wise?restaurantId=" +
        restaurant.id
    );
  ...
  const deleteFood = (foodId, e) => {
    fetch(
      "https://online-registration-production.up.railway.app/api/food/delete?foodId=" +
        foodId +
        "&restaurantId=" +
        restaurant.id,
      {
                ...
                {allFoods.map((food) => {
                  return (
                    <tr>
                      <td>
                        <img
                          src={"https://online-registration-production.up.railway.app/api/food/" + food.image1}
                          class="img-fluid"
                          alt="food_pic"
                          style={{
                            maxWidth: "90px",
