...
const Food = () => {
  ...
  const retrieveFood = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/food/fetch?foodId=" + foodId
    );
  ...
  const retrieveFoodsByCategory = async () => {
    const response = await axios.get(
      "https://online-registration-production.up.railway.app/api/food/fetch/category-wise?categoryId=" +
        categoryId
    );
  ...
  const saveFoodToCart = (userId) => {
    fetch("https://online-registration-production.up.railway.app/api/cart/add", {
      method: "POST",
      headers: {
